    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Index(int? id, int? productID)
        {
            ...
            viewModel.Employees = db.Employees
                .Include(i => i.DepartmentAssignment)
                .Include(i => i.Products.Select(c => c.Department))
            ...
            if (productID != null)
            {
                ...
                viewModel.Transactions = viewModel.Products.Where(
                    x => x.ProductID == productID).Single().Transactions;
            }
        ...
        {
            ViewBag.ID = new SelectList(db.DepartmentAssignments, "EmployeeID", "Location");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstMidName,HireDate")] Employee employee)
        {
            ...
            ViewBag.ID = new SelectList(db.DepartmentAssignments, "EmployeeID", "Location", employee.ID);
            return View(employee);
        }
