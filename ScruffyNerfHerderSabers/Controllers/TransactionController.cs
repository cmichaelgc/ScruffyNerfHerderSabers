...
namespace ScruffyNerfHerderSabers.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TransactionID,ProductID,CustomerID")] Transaction transaction)
        {
            ...
            ViewBag.CustomerID = new SelectList(db.Customers, "ID", "LastName", transaction.CustomerID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TransactionID,ProductID,CustomerID")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
