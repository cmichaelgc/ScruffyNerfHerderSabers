...
namespace ScruffyNerfHerderSabers.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter,  string searchString, int? page)
        {
            ...
            switch (sortOrder)
            {
                ...
                case "Date":
                    ...
                    break;
                case "date_desc":
                    customers = customers.OrderByDescending(c => c.TransactionDate);
                    break;
                default:
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstMidName,Rank,TransactionDate")] Customer customer)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(customerToUpdate, "",
                new string[] { "LastName", "FirstMidName", "Rank", "TransactionDate" }))
            {
                try
                {
                    db.SaveChanges();
